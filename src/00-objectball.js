...
function doesLongNameStealATon() {
    ...
    // Get steals of the player with the longest name
    for (let team in game) {
        if (game[team].players[longestName]) {
            playerWithLongestNameSteals = game[team].players[longestName].steals;
        }
    }

    return playerWithLongestNameSteals === maxSteals;
}
